...
class _DetailsPageState extends State<DetailsPage> {
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            buildIngredientItem(
                                'Toffee Nut Syrup',
                                // Icon(Feather.getIconData('peanut-outline'),
                                //     size: 10.0, color: Colors.white),
                                Color(0xFF8FC28A)),
                            buildIngredientItem(
                                'Natural Flavors',
                                // Icon(Feather.getIconData('leaf-maple'),
                                //     size: 18.0, color: Colors.white),
                                Color(0xFF3B8079)),
                            buildIngredientItem(
                                'Vanilla Syrup',
                                // Icon(Feather.getIconData('flower-tulip-outline'),
                                //     size: 10.0, color: Colors.white),
                                Color(0xFFF8B870)),
  ...
  buildIngredientItem(String name,  Color bgColor) {
    return Padding(
